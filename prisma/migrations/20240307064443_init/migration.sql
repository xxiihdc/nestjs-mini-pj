...
CREATE TABLE `Group` (
    ...
    INDEX `Group_company_id_fkey`(`company_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Holiday` (
    ...
    INDEX `Holiday_company_id_fkey`(`company_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `UserTimeSheet` (
    ...
    INDEX `UserTimeSheet_edited_by_id_fkey`(`edited_by_id`),
    INDEX `UserTimeSheet_employee_id_fkey`(`employee_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateIndex
CREATE INDEX `Employee_company_id_fkey` ON `Employee`(`company_id`);
